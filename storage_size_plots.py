...
def plot_average_error(sh, jl, ps):
    ...
    plt.title('Comparison of Average Relative Error (n = 10000)')
    ...
    plt.savefig('./results/storage_average_error.png')
...
jl = pd.read_csv('./results/storage_JL.csv')
ps = pd.read_csv('./results/storage_PrioritySampling.csv')
