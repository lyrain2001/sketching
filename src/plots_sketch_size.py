...
def plot_average_error(sh, jl, ps):
    ...
    plt.savefig('./results/sketch_size/sketch_error_olp0.5.png')
...
def plot_time(sh, jl, ps):
    ...
    plt.savefig('./results/sketch_size/sketch_time_olp0.5.png')


sh = pd.read_csv('./results/sketch_size/sketch_size_olp0.5_SimHash.csv', header=None)
jl = pd.read_csv('./results/sketch_size/sketch_size_olp0.5_JL.csv', header=None)
ps = pd.read_csv('./results/sketch_size/sketch_size_olp0.5_PrioritySampling.csv', header=None)
